...
Q05.40 Create a separate file **_.py_** file called **_greetings.py_**. Inside of **_greetings.py_** include the code:
...
Import you newly created **_greatings.py_** file and run the function ```hi()```.

Q05.41 Create a separate file **_.py_** file called **_greetings.py_**. Inside of **_greetings.py_** include the code:
...
Import you newly created **_greatings.py_** file and run the function ```hello()``` with your name as an input argument.
...
Import you newly created **_areas.py_** file and run the functions ```triangle()``` and ```rectangle()``` with the same two input arguments: ```2``` and ```3```.
